export const database = [
    ...
    { name: 'Avatar', imgUrl: 'https://media-cache.cinematerial.com/p/500x/ayniyqcx/avatar-the-way-of-water-movie-poster.jpg?v=1667461543' },
    { name: 'Cars 2', imgUrl: 'https://upload.wikimedia.org/wikipedia/en/7/7f/Cars_2_Poster.jpg' },
    { name: 'M3GAN', imgUrl: 'https://www.cinematerial.com/media/box-office/8760708.jpg' },
...
export const availibility = {
    ...
    'Avatar': [4, 6, 8,10,11,12,13,14,15,16],
    'Cars 2': [3, 5, 7, 9,20,21,12,13,19,24],
    'M3GAN': [1, 3, 7, 9,20,21,12,13,19,24],
    'Cars 3': [3, 5, 7, 9,13,16,21]
}
